...
> 나라장터 차량 렌트 공고 해석 플랫폼

GAR은 공공기관 차량 렌트/임차 입찰공고를 자동 수집·분석하여, 자동차대여 사업자에게 공고 해석, 자격 체크, 적격심사 시뮬레이션을 제공하는 SaaS입니다.
...
- **✅ 자격 체크** — 소재지·프로필 기준으로 입찰 가능성 빠른 판단
- **📊 적격심사 시뮬레이션** — 프로필 기반 예상 점수와 부족 항목 안내
